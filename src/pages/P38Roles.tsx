...
import { P38RolesWorkspace } from '../components/page-specific/P38RolesWorkspace';
import { usePrototypePage } from '../components/usePrototypePage';

const spec = pageSpecById.P38;

export default function P38Roles() {
  ...
  return <PageFrame spec={spec} fixture={page.fixture} adapterError={page.adapterError} viewState={page.viewState} setViewState={page.setViewState}>
    {page.fixture && <P38RolesWorkspace fixture={page.fixture} />}
  </PageFrame>;
}