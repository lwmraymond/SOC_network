...
function P41Workspace() {
  ...
  return <div className="pageComposition differentiatedPage p41Auth" data-page-specific-composition="P41-provider-topology-testing-rollout">
    <style>{`.p41Auth{display:flex;flex-direction:column;gap:24px;min-width:0}.p41Auth *{box-sizing:border-box}.p41Command{display:grid;grid-template-columns:minmax(280px,1fr) minmax(150px,auto) auto;gap:10px;align-items:end}.p41Topology{display:grid;grid-template-columns:minmax(0,1fr) minmax(0,1fr);gap:16px}.p41Topology>.euiPanel{min-width:0}.p41Chain{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:12px;padding:4px 0}.p41Chain article{position:relative;min-width:0;padding:10px 8px;border:1px solid var(--euiBorderColor,#d3dae6);border-radius:4px}.p41Chain article:not(:last-child)::after{content:'→';position:absolute;z-index:1;right:-10px;top:50%;translate:50% -50%;color:var(--euiTextSubduedColor,#69707d)}.p41Chain strong,.p41Chain small{display:block;overflow-wrap:anywhere}.p41Chain small{margin-top:3px;line-height:1.25}.p41Workspace{display:grid;grid-template-columns:minmax(620px,1.4fr) minmax(330px,.8fr);gap:24px;align-items:start}.p41TableWrap{overflow:auto}.p41Table{width:100%;min-width:850px;border-collapse:collapse}.p41Table th,.p41Table td{padding:10px;border-bottom:1px solid var(--euiBorderColor,#d3dae6);text-align:left;vertical-align:top}.p41Table small{display:block;margin-top:4px;color:var(--euiTextSubduedColor,#69707d)}.p41Tabs{display:flex;gap:4px;margin:14px 0;border-bottom:1px solid var(--euiBorderColor,#d3dae6);overflow:auto}.p41Tabs button{padding:9px 11px;border:0;border-bottom:2px solid transparent;background:transparent;color:inherit;white-space:nowrap}.p41Tabs button[aria-selected=true]{border-color:var(--euiColorPrimary,#006bb4);font-weight:600}.p41Health{display:grid;grid-template-columns:1fr 1fr;gap:8px}.p41Health article{padding:10px;border:1px solid var(--euiBorderColor,#d3dae6);border-radius:4px}.p41Health header{display:flex;justify-content:space-between;gap:8px}.p41Mapping{display:grid;gap:8px}.p41Mapping article{padding:10px;border-left:3px solid var(--euiColorPrimary,#006bb4);background:var(--euiColorLightestShade,#f5f7fa)}@media(max-width:1050px){.p41Topology,.p41Workspace{grid-template-columns:1fr}}@media(max-width:720px){.p41Command,.p41Health{grid-template-columns:1fr}.p41Chain{grid-template-columns:repeat(2,minmax(0,1fr))}.p41Chain article::after{display:none}}@media(max-width:440px){.p41Chain{grid-template-columns:1fr}}`}</style>
