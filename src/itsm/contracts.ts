...
export type ItsmEndpointDescriptor = {
  status: 'verified' | 'tbd';
  path?: string;
  source?: string;
  notes?: string;
...
export const ITSM_ENDPOINTS = {
  getCapabilities: { status: 'tbd', notes: 'Capability-probing endpoint has not been verified.' },
  listTickets: { status: 'tbd' },
  getTicket: { status: 'tbd' },
  previewCreateTicket: { status: 'tbd' },
  createTicket: { status: 'tbd' },
  previewUpdateTicket: { status: 'tbd' },
  updateTicket: { status: 'tbd' },
  refreshTicket: { status: 'tbd', notes: 'May reuse a verified ticket-detail GET endpoint when configured.' },
  listComments: { status: 'tbd' },
  previewCreateComment: { status: 'tbd' },
  createComment: { status: 'tbd' },
  createAttachmentPlaceholder: { status: 'tbd' },
  listRelations: { status: 'tbd' },
  createRelation: { status: 'tbd' },
  listApprovals: { status: 'tbd' },
  decideApproval: { status: 'tbd' },
  listAuditEvents: { status: 'tbd' },
  listSlaPolicies: { status: 'tbd' },
  listBusinessCalendars: { status: 'tbd' },
  listSlaClocks: { status: 'tbd' },
  listEscalationRules: { status: 'tbd' },
  previewSlaPolicy: { status: 'tbd' },
  saveSlaPolicy: { status: 'tbd' },
  listAutomationTemplates: { status: 'tbd' },
  listAutomationRules: { status: 'tbd' },
  listAutomationVersions: { status: 'tbd' },
  listAutomationRuns: { status: 'tbd' },
  previewAutomationRule: { status: 'tbd' },
  saveAutomationRule: { status: 'tbd' },
  publishAutomationRule: { status: 'tbd' },
  dryRunAutomationRule: { status: 'tbd' },
  retryAutomationRun: { status: 'tbd' },
  cancelAutomationRun: { status: 'tbd' },
  listNotificationProviders: { status: 'tbd' },
  listNotificationRecipients: { status: 'tbd' },
  listNotificationTemplates: { status: 'tbd' },
  listNotificationPolicies: { status: 'tbd' },
  listNotificationDeliveries: { status: 'tbd' },
  saveNotificationProvider: { status: 'tbd' },
  testNotificationProvider: { status: 'tbd' },
  listInboundMailboxes: { status: 'tbd' },
  listInboundRoutingRules: { status: 'tbd' },
  listIngestionEvents: { status: 'tbd' },
  saveInboundMailbox: { status: 'tbd' },
  testInboundMailbox: { status: 'tbd' },
} as const satisfies Record<keyof ItsmApiAdapter, ItsmEndpointDescriptor>;
